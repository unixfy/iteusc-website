<footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
    <div class="grid grid-flow-col gap-4">
        ...
        <a class="link link-hover" href="https://forms.gle/TQKCiMyscURNHgGMA" rel="noreferrer" target="_blank">Subscribe to emails</a>
        <a class="link link-hover" href="/auth/login/">Sign in</a>
    </div>
    <div>
        <div class="grid grid-flow-col gap-4">
            <!--            Facebook -->
            <a class="btn btn-circle" href="https://www.facebook.com/iteusc/" rel="noreferrer" target="_blank" aria-label="Facebook">
            ...
            <!--            Instagram -->
            <a class="btn btn-circle" href="https://www.instagram.com/usc.ite/?hl=en" rel="noreferrer" target="_blank" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
