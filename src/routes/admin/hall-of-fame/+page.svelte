...
<PageHeader
    title="Manage Hall of Fame"
    subtitle="Create/read/update/delete hall of fame items"
/>
...
<div class="ct">
    ...
    <div class="flex justify-between mb-4">
        ...
        <!--Create new button -->
        <label for="create-modal" class="btn btn-primary"
            >Add new hall of fame item</label
        >
    </div>
            ...
            >
                ...
                <div class="form-control w-full">
                    <label class="label">
                        ...
                        <span class="label-text-alt">Person's name</span>
                    </label>
                    <input
                        type="text"
                        name="name"
                ...
                <div class="form-control w-full">
                    <label class="label">
                        ...
                        <span class="label-text-alt">Person's biography</span>
                    </label>
                    <textarea
                        type="text"
                        name="bio"
                ...
                <div class="form-control w-full">
                    <label class="label">
                        ...
                        <span class="label-text-alt"
                            >Order that this hall of fame should display in</span
                        >
                    </label>
                    <input
                        type="number"
                    ...
                    <label class="label">
                        <span class="label-text"
                            >Smaller numbers display first</span
                        >
                    </label>
                </div>
                ...
                <div class="form-control w-full">
                    <label class="label">
                        <span class="label-text">Person's headshot</span>
                        <span class="label-text-alt"
                            >Ideally 1:1 (square), must be an image</span
                        >
                    </label>
                    <input
                        type="file"
                ...
                {#each data.items as item}
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label
                                for="edit-modal-{item.id}"
                                class="btn btn-sm btn-primary"
                            >
                                Edit
                            </label>
                            <label
                                for="delete-confirm-modal-{item.id}"
                    ...
                    <div class="modal">
                        <div class="modal-box space-y-4">
                            <!--                        Image -->
                            <img
                                src={getStorageDirectUrl(item.image)}
                                alt="{item.name}'s headshot"
                    ...
                    <input
                        type="checkbox"
                        id="delete-confirm-modal-{item.id}"
                        class="modal-toggle"
                    />
                    <div class="modal">
                        <div class="modal-box space-y-4">
